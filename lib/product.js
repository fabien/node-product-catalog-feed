...
class Product {
  ...
  /**
   * Gets a value to specify additional landing page parameters on a product page that can be used for Shopping ads
   * @returns {String} URL
   */
  get adwordsRedirect() {
  ...
  /**
   * Sets a value to specify additional landing page parameters on a product page that can be used for Shopping ads
  ...
  /**
   * Gets an identifier that can be used in both product data and promotions data to match products to promotions
   * @returns {String|Array}
   */
  get promotionId() {
  ...
  /**
   * Sets an identifier that can be used in both product data and promotions data to match products to promotions
   * @param {String|Array} value
   */
  ...
  /**
   * Gets a minimum value indicating how long it will take for a product to arrive at its destination.
   * @returns {Number}
   */
  get minHandlingTime() {
  ...
  /**
   * Sets a minimum value indicating how long it will take for a product to arrive at its destination.
   * @param {Number} value
   */
  ...
  /**
   * Gets a maximum value indicating how long it will take for a product to arrive at its destination.
   * @returns {Number}
   */
  get maxHandlingTime() {
  ...
  /**
   * Sets a maximum value indicating how long it will take for a product to arrive at its destination.
   * @param {Number} value
   */
