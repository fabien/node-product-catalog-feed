...
var { Product, ProductPrice, UnitPricingMeasure, ProductInstallment, ProductDateRange, ProductLoyaltyPoints, ProductShipping, ShippingWeight, ShippingDimension, ProductTax } = require('../lib/product');
var { FeedBuilder } = require('../lib/feedBuilder');

describe('FeedBuilder', function () {
  describe('build', function () {
    it('returns expected document', function () {
